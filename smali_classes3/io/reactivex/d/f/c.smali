...
.method public constructor <init>(I)V
    ...
    .line 54
    invoke-direct {p0, p1}, Lio/reactivex/d/f/c;->a(I)V
...
.method private static a(JI)I
    ...
    .line 241
    invoke-static {p0}, Lio/reactivex/d/f/c;->b(I)I
...
.method private a(Ljava/util/concurrent/atomic/AtomicReferenceArray;JI)Ljava/lang/Object;
    ...
    .line 153
    iput-object p1, p0, Lio/reactivex/d/f/c;->h:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    .line 154
    invoke-static {p2, p3, p4}, Lio/reactivex/d/f/c;->a(JI)I

    move-result p4

    .line 155
    invoke-static {p1, p4}, Lio/reactivex/d/f/c;->b(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/lang/Object;
    ...
    .line 157
    invoke-static {p1, p4, v1}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V
    ...
    .line 158
    invoke-direct {p0, p2, p3}, Lio/reactivex/d/f/c;->b(J)V
...
.method private a(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    .line 119
    invoke-static {p2}, Lio/reactivex/d/f/c;->b(I)I

    move-result p2

    .line 120
    invoke-static {p1, p2}, Lio/reactivex/d/f/c;->b(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/lang/Object;
    ...
    .line 121
    invoke-static {p1, p2, v1}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V
...
.method private a(I)V
    ...
    sget v0, Lio/reactivex/d/f/c;->a:I
...
.method private a(Ljava/util/concurrent/atomic/AtomicReferenceArray;JILjava/lang/Object;J)V
    ...
    .line 106
    invoke-static {v1, p4, p5}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V

    .line 107
    invoke-direct {p0, p1, v1}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/util/concurrent/atomic/AtomicReferenceArray;)V

    .line 108
    sget-object p5, Lio/reactivex/d/f/c;->j:Ljava/lang/Object;

    invoke-static {p1, p4, p5}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V
...
.method private a(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/util/concurrent/atomic/AtomicReferenceArray;)V
    ...
    invoke-static {v0}, Lio/reactivex/d/f/c;->b(I)I

    move-result v0

    invoke-static {p1, v0, p2}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V
...
.method private a(Ljava/util/concurrent/atomic/AtomicReferenceArray;Ljava/lang/Object;JI)Z
    ...
    .line 95
    invoke-static {p1, p5, p2}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V
...
.method public a(Ljava/lang/Object;)Z
    ...
    .line 73
    invoke-direct {p0}, Lio/reactivex/d/f/c;->f()J
    ...
    .line 75
    invoke-static {v3, v4, v0}, Lio/reactivex/d/f/c;->a(JI)I
    ...
    .line 81
    invoke-static {v6, v7, v0}, Lio/reactivex/d/f/c;->a(JI)I

    move-result v2

    .line 82
    invoke-static {v1, v2}, Lio/reactivex/d/f/c;->b(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/lang/Object;
    ...
    .line 85
    invoke-static {v8, v9, v0}, Lio/reactivex/d/f/c;->a(JI)I
...
.method public aM_()Ljava/lang/Object;
    ...
    .line 135
    invoke-direct {p0}, Lio/reactivex/d/f/c;->g()J
    ...
    .line 137
    invoke-static {v1, v2, v3}, Lio/reactivex/d/f/c;->a(JI)I

    move-result v4

    .line 138
    invoke-static {v0, v4}, Lio/reactivex/d/f/c;->b(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/lang/Object;
    ...
    .line 141
    invoke-static {v0, v4, v7}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;ILjava/lang/Object;)V
    ...
    .line 145
    invoke-direct {p0, v0, v4}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;I)Ljava/util/concurrent/atomic/AtomicReferenceArray;

    move-result-object v0

    invoke-direct {p0, v0, v1, v2, v3}, Lio/reactivex/d/f/c;->a(Ljava/util/concurrent/atomic/AtomicReferenceArray;JI)Ljava/lang/Object;
...
.method public d()Z
    ...
    .line 209
    invoke-direct {p0}, Lio/reactivex/d/f/c;->a()J

    move-result-wide v0

    invoke-direct {p0}, Lio/reactivex/d/f/c;->b()J
...
.method public e()V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lio/reactivex/d/f/c;->aM_()Ljava/lang/Object;
