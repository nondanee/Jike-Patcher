...
.method private static a(Landroid/content/Context;Ljava/util/List;)Ljava/util/HashMap;
    ...
    invoke-static {p0, v1}, Lcom/xiaomi/push/hq;->a(Landroid/content/Context;Lcom/xiaomi/push/hx;)V

    invoke-virtual {v1}, Lcom/xiaomi/push/hx;->k()Ljava/lang/String;
...
.method private static a(Landroid/content/Context;Lcom/xiaomi/push/hs;Ljava/util/HashMap;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1}, Lcom/xiaomi/push/hx;->p()Ljava/lang/String;
    ...
    invoke-interface {p1, v0, v1, p2}, Lcom/xiaomi/push/hs;->a(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public static a(Landroid/content/Context;Lcom/xiaomi/push/hs;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lcom/xiaomi/push/hq;->a(Landroid/content/Context;Ljava/util/List;)Ljava/util/HashMap;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lcom/xiaomi/push/hq;->a(Landroid/content/Context;Lcom/xiaomi/push/hs;Ljava/util/HashMap;)V
...
.method private static a(Landroid/content/Context;Lcom/xiaomi/push/hx;)V
    ...
    iget-boolean v0, p1, Lcom/xiaomi/push/hx;->f:Z
    ...
    invoke-virtual {p1, p0}, Lcom/xiaomi/push/hx;->e(Ljava/lang/String;)Lcom/xiaomi/push/hx;
