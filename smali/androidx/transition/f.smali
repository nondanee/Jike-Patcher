...
.method static constructor <clinit>()V
    ...
    .line 54
    new-instance v0, Landroidx/transition/f$1;

    invoke-direct {v0}, Landroidx/transition/f$1;-><init>()V

    sput-object v0, Landroidx/transition/f;->i:Landroid/animation/TypeEvaluator;

    .line 61
    new-instance v0, Landroidx/transition/f$2;

    const-class v1, Landroid/graphics/Matrix;

    const-string v2, "animatedTransform"

    invoke-direct {v0, v1, v2}, Landroidx/transition/f$2;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Landroidx/transition/f;->j:Landroid/util/Property;
...
.method private a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    ...
    .line 177
    sget-object v0, Landroidx/transition/f;->j:Landroid/util/Property;

    sget-object v1, Landroidx/transition/f;->i:Landroid/animation/TypeEvaluator;
...
.method private a(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    new-instance v1, Landroidx/transition/aj$a;

    invoke-direct {v1}, Landroidx/transition/aj$a;-><init>()V
...
.method private static b(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    .line 188
    sget-object v0, Landroidx/transition/f$3;->a:[I
    ...
    .line 192
    :pswitch_0
    invoke-static {p0}, Landroidx/transition/f;->d(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    .line 190
    :pswitch_1
    invoke-static {p0}, Landroidx/transition/f;->c(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method public a(Landroid/view/ViewGroup;Landroidx/transition/ak;Landroidx/transition/ak;)Landroid/animation/Animator;
    ...
    .line 155
    invoke-static {p1}, Landroidx/transition/q;->a(Landroid/widget/ImageView;)V
    ...
    .line 162
    sget-object p2, Landroidx/transition/s;->a:Landroid/graphics/Matrix;

    :cond_7
    if-nez v2, :cond_8

    .line 165
    sget-object v2, Landroidx/transition/s;->a:Landroid/graphics/Matrix;

    .line 167
    :cond_8
    sget-object p3, Landroidx/transition/f;->j:Landroid/util/Property;

    invoke-virtual {p3, p1, p2}, Landroid/util/Property;->set(Ljava/lang/Object;Ljava/lang/Object;)V

    .line 168
    invoke-direct {p0, p1, p2, v2}, Landroidx/transition/f;->a(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    :cond_9
    :goto_1
    invoke-direct {p0, p1}, Landroidx/transition/f;->a(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;

    move-result-object p2

    .line 171
    :goto_2
    invoke-static {p1, p2}, Landroidx/transition/q;->a(Landroid/widget/ImageView;Landroid/animation/Animator;)V
...
.method public a(Landroidx/transition/ak;)V
    ...
    .line 105
    invoke-direct {p0, p1}, Landroidx/transition/f;->d(Landroidx/transition/ak;)V
...
.method public a()[Ljava/lang/String;
    ...
    .line 115
    sget-object v0, Landroidx/transition/f;->a:[Ljava/lang/String;
