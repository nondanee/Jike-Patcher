...
.method public static declared-synchronized a()J
    ...
    sget-wide v3, Lcom/loc/bd;->a:J

    cmp-long v5, v1, v3

    if-lez v5, :cond_0

    sput-wide v1, Lcom/loc/bd;->a:J

    goto :goto_0

    :cond_0
    sget-wide v1, Lcom/loc/bd;->a:J
...
.method private a(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-static {v15, v0}, Lcom/loc/cw;->a(Lcom/amap/api/location/DPoint;Lcom/amap/api/location/DPoint;)F
    ...
    invoke-direct {v4, v0, v2}, Lcom/loc/bd;->a(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-direct {v4, v1, v2}, Lcom/loc/bd;->a(Ljava/util/List;F)Ljava/util/List;
...
.method public static b(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)I
    ...
    invoke-static {p0, p1, p2}, Lcom/loc/bd;->a(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)I
...
.method public final c(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)I
    ...
    invoke-virtual {v3, v4, v5}, Lcom/amap/api/location/DPoint;->setLatitude(D)V
    ...
    invoke-virtual {v3, v4, v5}, Lcom/amap/api/location/DPoint;->setLongitude(D)V
    ...
    invoke-virtual {v14, v0}, Lcom/amap/api/fence/GeoFence;->setType(I)V

    invoke-virtual {v14, v6}, Lcom/amap/api/fence/GeoFence;->setRadius(F)V

    invoke-virtual {v14, v11, v12}, Lcom/amap/api/fence/GeoFence;->setExpiration(J)V
    ...
    invoke-virtual {v14, v0}, Lcom/amap/api/fence/GeoFence;->setFenceId(Ljava/lang/String;)V
    ...
    invoke-direct {v0}, Lcom/amap/api/fence/DistrictItem;-><init>()V
    ...
    invoke-virtual {v0, v9}, Lcom/amap/api/fence/DistrictItem;->setCitycode(Ljava/lang/String;)V

    invoke-virtual {v0, v10}, Lcom/amap/api/fence/DistrictItem;->setAdcode(Ljava/lang/String;)V

    invoke-virtual {v0, v2}, Lcom/amap/api/fence/DistrictItem;->setDistrictName(Ljava/lang/String;)V
    ...
    invoke-direct {v10, v11, v12, v14, v15}, Lcom/amap/api/location/DPoint;-><init>(DD)V
    ...
    :try_start_1
    invoke-direct {v2, v7, v6}, Lcom/loc/bd;->a(Ljava/util/List;F)Ljava/util/List;
    ...
    invoke-virtual {v0, v7}, Lcom/amap/api/fence/DistrictItem;->setPolyline(Ljava/util/List;)V
    ...
    invoke-virtual {v9, v5}, Lcom/amap/api/fence/GeoFence;->setMaxDis2Center(F)V

    invoke-virtual {v9, v1}, Lcom/amap/api/fence/GeoFence;->setMinDis2Center(F)V

    invoke-virtual {v9, v8}, Lcom/amap/api/fence/GeoFence;->setDistrictItemList(Ljava/util/List;)V

    invoke-virtual {v9, v13}, Lcom/amap/api/fence/GeoFence;->setPointList(Ljava/util/List;)V
