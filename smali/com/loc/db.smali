...
.method public constructor <init>(Landroid/content/Context;Landroid/webkit/WebView;)V
    ...
    iput-object v0, p0, Lcom/loc/db;->a:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/loc/db;->e:Lcom/amap/api/location/AMapLocationClient;

    iput-object v0, p0, Lcom/loc/db;->f:Landroid/webkit/WebView;

    const-string v1, "AMap.Geolocation.cbk"

    iput-object v1, p0, Lcom/loc/db;->g:Ljava/lang/String;

    iput-object v0, p0, Lcom/loc/db;->b:Lcom/amap/api/location/AMapLocationClientOption;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/loc/db;->h:Z

    iput-object v0, p0, Lcom/loc/db;->c:Lcom/loc/db$a;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lcom/loc/db;->d:Landroid/content/Context;

    iput-object p2, p0, Lcom/loc/db;->f:Landroid/webkit/WebView;

    new-instance p1, Lcom/loc/db$a;

    invoke-direct {p1, p0}, Lcom/loc/db$a;-><init>(Lcom/loc/db;)V

    iput-object p1, p0, Lcom/loc/db;->c:Lcom/loc/db$a;
...
.method static synthetic a(Lcom/amap/api/location/AMapLocation;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/loc/db;->b(Lcom/amap/api/location/AMapLocation;)Ljava/lang/String;
...
.method static synthetic a(Lcom/loc/db;)Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Lcom/loc/db;->g:Ljava/lang/String;

    return-object p0
.end method

.method static synthetic a(Lcom/loc/db;Ljava/lang/String;)V
    .locals 3

    :try_start_0
    iget-object v0, p0, Lcom/loc/db;->f:Landroid/webkit/WebView;
    ...
    iget-object v2, p0, Lcom/loc/db;->g:Ljava/lang/String;
    ...
    new-instance v1, Lcom/loc/db$1;

    invoke-direct {v1, p0}, Lcom/loc/db$1;-><init>(Lcom/loc/db;)V
    ...
    new-instance v1, Lcom/loc/db$2;

    invoke-direct {v1, p0, p1}, Lcom/loc/db$2;-><init>(Lcom/loc/db;Ljava/lang/String;)V
...
.method static synthetic b(Lcom/loc/db;)Landroid/webkit/WebView;
    .locals 0

    iget-object p0, p0, Lcom/loc/db;->f:Landroid/webkit/WebView;
...
.method static synthetic c(Lcom/loc/db;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/loc/db;->h:Z
...
.method public final a()V
    ...
    iget-object v0, p0, Lcom/loc/db;->d:Landroid/content/Context;
    ...
    :cond_1
    iget-boolean v0, p0, Lcom/loc/db;->h:Z
    ...
    :cond_3
    iget-object v0, p0, Lcom/loc/db;->e:Lcom/amap/api/location/AMapLocationClient;

    if-nez v0, :cond_4

    new-instance v0, Lcom/amap/api/location/AMapLocationClient;

    iget-object v2, p0, Lcom/loc/db;->d:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/loc/db;->c:Lcom/loc/db$a;
...
.method public final b()V
    ...
    iget-object v0, p0, Lcom/loc/db;->a:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lcom/loc/db;->e:Lcom/amap/api/location/AMapLocationClient;
    ...
    iget-object v3, p0, Lcom/loc/db;->c:Lcom/loc/db$a;
    ...
    iput-object v2, p0, Lcom/loc/db;->e:Lcom/amap/api/location/AMapLocationClient;

    :cond_0
    iput-object v2, p0, Lcom/loc/db;->b:Lcom/amap/api/location/AMapLocationClientOption;
...
.method public final getLocation(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/loc/db;->b:Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iput-object v1, p0, Lcom/loc/db;->b:Lcom/amap/api/location/AMapLocationClientOption;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_2
    iput-object v6, p0, Lcom/loc/db;->g:Ljava/lang/String;
    ...
    :goto_3
    :try_start_4
    iget-object v6, p0, Lcom/loc/db;->b:Lcom/amap/api/location/AMapLocationClientOption;
    ...
    iget-object p1, p0, Lcom/loc/db;->b:Lcom/amap/api/location/AMapLocationClientOption;
    ...
    :cond_7
    :try_start_5
    iget-object p1, p0, Lcom/loc/db;->e:Lcom/amap/api/location/AMapLocationClient;
