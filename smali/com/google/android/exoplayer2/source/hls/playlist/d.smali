...
# static fields
.field public static final a:Lcom/google/android/exoplayer2/source/hls/playlist/d;
...
.method static constructor <clinit>()V
    ...
    sput-object v13, Lcom/google/android/exoplayer2/source/hls/playlist/d;->a:Lcom/google/android/exoplayer2/source/hls/playlist/d;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/google/android/exoplayer2/l;Ljava/util/List;ZLjava/util/Map;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 219
    invoke-static {p3, p4, p5, p6, p7}, Lcom/google/android/exoplayer2/source/hls/playlist/d;->a(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->b:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->c:Ljava/util/List;
    ...
    .line 225
    iput-object p8, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->h:Lcom/google/android/exoplayer2/l;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->j:Ljava/util/Map;
...
.method public static a(Ljava/lang/String;)Lcom/google/android/exoplayer2/source/hls/playlist/d;
    .locals 13
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/source/hls/playlist/d$b;->a(Landroid/net/Uri;)Lcom/google/android/exoplayer2/source/hls/playlist/d$b;
...
.method public b(Ljava/util/List;)Lcom/google/android/exoplayer2/source/hls/playlist/d;
    ...
    iget-object v1, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->n:Ljava/lang/String;

    iget-object v2, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->o:Ljava/util/List;

    iget-object v0, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->c:Ljava/util/List;

    const/4 v3, 0x0

    .line 237
    invoke-static {v0, v3, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/d;->a(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    .line 240
    invoke-static {v0, v5, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/d;->a(Ljava/util/List;ILjava/util/List;)Ljava/util/List;

    move-result-object v5

    iget-object v0, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->f:Ljava/util/List;

    const/4 v6, 0x2

    .line 241
    invoke-static {v0, v6, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/d;->a(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    iget-object v8, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->h:Lcom/google/android/exoplayer2/l;

    iget-object v9, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->i:Ljava/util/List;

    iget-boolean v10, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->p:Z

    iget-object v11, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->j:Ljava/util/Map;

    iget-object v12, p0, Lcom/google/android/exoplayer2/source/hls/playlist/d;->k:Ljava/util/List;
