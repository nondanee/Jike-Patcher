...
.method public static parse(Lorg/json/JSONObject;)Lcom/meizu/cloud/pushsdk/notification/model/AppIconSetting;
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lcom/meizu/cloud/pushsdk/notification/model/AppIconSetting;->setDefaultLargeIcon(Z)V
    ...
    invoke-virtual {v0, p0}, Lcom/meizu/cloud/pushsdk/notification/model/AppIconSetting;->setLargeIconUrl(Ljava/lang/String;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_2
    const-string p0, "app_icon_setting"

    const-string v1, "no such tag app_icon_setting"
